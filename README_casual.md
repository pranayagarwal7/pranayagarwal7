...
End-to-end ML pipeline for predicting insurance costs. Used SHAP to make the model explainable — not just accurate. Hooked up to a Tableau dashboard and a REST API.

**Wireless Customer Churn Prediction**
Built a churn model and focused on interpretability over raw accuracy, because a model a business team can act on beats a black box every time.

**Highway Traffic Forecasting**
Compared regression, decision tree, and random forest on I-94 traffic data. Built a Power BI dashboard for the non-technical folks who actually use it.

**Loan Approval Prediction**
Voting ensemble with SMOTE to handle imbalanced classes. Ended up at 84% accuracy and 0.91 ROC-AUC.

---

Open to Data Analyst and ML roles in Canada. Feel free to reach out.
